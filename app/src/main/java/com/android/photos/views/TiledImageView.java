...
public class TiledImageView extends FrameLayout {
    ...
    public void destroy() {
        ...
        if (USE_TEXTURE_VIEW) {
            ...
            /* SPRD: bug337786 2014-07-29 OOM problem optimize. @{ */
            // GLThread may stop first and cause this Runnable not execute.
            mFreeTextures.run();
    ...
    public void setTileSource(TileSource source, Runnable isReadyCallback) {
        ...
        synchronized (mLock) {
            /* SPRD: bug324816 2014-06-18 free texture generated previous. @{ */
