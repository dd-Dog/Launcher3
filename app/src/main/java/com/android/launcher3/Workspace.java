...
/* SPRD: bug336774 2014-07-24 strip screen if no database record ref it. @{ */
import android.content.ContentResolver;
import android.database.Cursor;
/* SPRD: bug336774 2014-07-24 strip screen if no database record ref it. @} */

/* SPRD: BugFix bug343981 2014-08-19 prompt the user when the folder is full. @{ */
...
public class Workspace extends SmoothPagedView
    ...
    public void onDragEnd() {
        ...
        /* SPRD: bug332620 2014-07-11 OOM problem optimize. @{ */
    ...
    protected void setWallpaperDimension() {
        ...
        // SPRD: BugFix bug351805 use Context.MODE_MULTI_PROCESS mode to loading the SharedPreferences.
    ...
    protected void screenScrolled(int screenCenter) {
        ...
        if (shouldOverScroll) {
            ...
            /* SPRD: bug 343319,Fixbug NullPointerException @{*/
            if(cl != null){
    ...
    */
    ...
    public boolean enterOverviewMode() {
        ...
        /* SPRD: bug346152 2014-08-26 Bugfix clear resize frame before enter overview mode. @{ */
        ...
        if (d.dragSource != this) {
            ...
            if (dropTargetLayout != null && !d.cancelled) {
                ...
                if (foundCell) {
                    ...
                    if (hasMovedLayouts) {
                        // Reparent the view
                        /* SPRD:fix bug 336479,the parentCellLayout is null @{
   ...
   static private float squaredDistance(float[] point1, float[] point2) {
    ...
    public void onDragOver(DragObject d) {
        ...
        ItemInfo item = (ItemInfo) d.dragInfo;
        /* SPRD: fix bug 317017,NullPointerException @{*/
        if (item == null) {
    ...
    public void onDropCompleted(final View target, final DragObject d,
        ...
        if (success && !(beingCalledAfterUninstall && !mUninstallSuccessful)) {
            ...
            /* SPRD: Fix bug 334644, cellLayout maybe is null. @{*/
            if(cellLayout != null){
