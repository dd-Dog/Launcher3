...
class AllAppsList {
    ...
    /**
     * Note: The return value indicate whether need remove all data for the package.
     *
     * @param context
     * @param packageName
     * @return
    ...
    public void updatePackage(Context context, String packageName) {
        updatePackageExt(context, packageName);
    }
    /* SPRD: bug345649 2014-08-14 Bugfix update launcher when package disabled. @} */
    ...
    /* SPRD: BugFix bug343227 2014-08-15 query the package manager for activities in the supplied intent. @{ */
