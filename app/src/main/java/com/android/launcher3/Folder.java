...
/* SPRD: bug341217 2014-08-11 delay remove the item while drag an item on opened folder. @{ */
...
public class Folder extends LinearLayout implements DragSource, View.OnClickListener,
    ...
    public void onDropCompleted(final View target, final DragObject d,
        ...
        if (successfulDrop) {
            ...
            /* SPRD: bug345658 2014-08-27 cn may be null. @{ */
            /* SPRD: bug341217 2014-08-11 delay remove the item while drag an item on opened folder. @{ */
    ...
    private void centerAboutIcon() {
        ...
        /* SPRD: bug352831 2014-09-19 Bugfix avoid NPE when workspace is null.@{ */
        ...
        /* SPRD: bug344063 2014-08-19 Fixbug prevent crash when child is null. @{ */
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        /* SPRD: bug324213 empty folder does not need measure. @{
    ...
    public void showItem(ShortcutInfo info) {
        View v = getViewForInfo(info);
        /* SPRD: fix bug328136, open the flight mode, drag the STK icon and drop to Folder,
         * cell may have been removed from the cell of parent, cause v is null. @{ */
        if (v != null) {
    ...
    public void onRemove(ShortcutInfo item) {
       ...
       if (getItemCount() <= 1) {
           if (mInfo.opened) {
               ...
               if (mDelayRemoveItem == null) {
                   /* SPRD: bug334234 2014-07-17 cancel drag if only one child left in folder. @{ */
