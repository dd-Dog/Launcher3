...
public class LauncherModel extends BroadcastReceiver {
    ...
    /* SPRD: bug342432 2014-08-13 Bugfix protect loadWorkspace when first create launcher db. @{ */
    private static final String PROTECT_WORKSPACE_LOADING_BROKEN = "PROTECT_WORKSPACE_LOADING_BROKEN";
    /* SPRD: bug342432 2014-08-13 Bugfix protect loadWorkspace when first create launcher db. @} */

    /* SPRD: BugFix bug344727 If apps can be on external storage, then we don't remove the apps form the DB, when shutdown. @{ */
    ...
    public void addAndBindAddedApps(final Context context, final ArrayList<ItemInfo> workspaceApps,
        ...
        /* SPRD: fix bug332579, NullPointerException the allAppsApps may be null. @{ */
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (Intent.ACTION_PACKAGE_CHANGED.equals(action)
            ...
            /* SPRD: BugFix bug344727 reload and binding workspace. @{ */
    ...
    private class LoaderTask implements Runnable {
        ...
        private boolean loadWorkspace() {
            ...
            synchronized (sBgLock) {
                ...
                /* SPRD: BugFix bug344727 If apps can be on external storage, then we need to keep this screen. @{ */
        ...
        public void run() {
            ...
            switch (mOp) {
                case OP_ADD:
                    ...
                    /* SPRD :fix bug 329169,Install the application to SDcard when reboot display error start@{*/
                    mWorkspaceLoaded =false;
                    /* end@} */
                    break;
                case OP_UPDATE:
