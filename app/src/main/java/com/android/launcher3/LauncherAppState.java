...
public class LauncherAppState {
    ...
    private static final String CIRCULAR_SLIDING_SCREEN_SWITCH = "circular_sliding_screen_switch";
    /* SPRD: Feature bug344910 2014-08-20 Support for circular sliding screen. @} */
    ...
    private LauncherAppState() {
        ...
        sContext.registerReceiver(mModel, filter);
        /* SPRD: BugFix bug344727 register shutdown broadcast receiver. @{ */
    ...
    /* SPRD: Feature bug344910 2014-08-20 Support for circular sliding screen. @{ */
    public static String getCircularSlidingScreenSwitchKey() {
        return CIRCULAR_SLIDING_SCREEN_SWITCH;
    }

    public boolean getCircularSlidingScreenSwitch() {
        SharedPreferences sp = sContext.getSharedPreferences(SHARED_PREFERENCES_KEY, Context.MODE_PRIVATE);
        return sp.getBoolean(CIRCULAR_SLIDING_SCREEN_SWITCH, false);
    }

    public void setCircularSlidingScreenSwitch(boolean status) {
        SharedPreferences sp = sContext.getSharedPreferences(SHARED_PREFERENCES_KEY, Context.MODE_PRIVATE);
        sp.edit().putBoolean(CIRCULAR_SLIDING_SCREEN_SWITCH, status).commit();
    }
    /* SPRD: Feature bug344910 2014-08-20 Support for circular sliding screen. @} */
}
