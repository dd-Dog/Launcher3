...
class DeviceProfile {
    ...
    void updateFromConfiguration(Resources resources, int wPx, int hPx,
        ...
        /* SPRD: Feature 314568,Replace the orignal initialize allapp of numRows and numColumns. @{
        if (isLandscape) {
        ...
        */
        allAppsNumRows = resources.getInteger(R.integer.config_allapp_rows);
        allAppsNumCols = resources.getInteger(R.integer.config_allapp_cols);
        /* @} */
    }
    ...
    public void layout(Launcher launcher) {
        ...
        /* SPRD: Fix bug312717,there is no need to add this view on Luancher,
